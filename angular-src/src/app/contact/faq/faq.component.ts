...
export class FaqComponent implements OnInit {
 ...
 faqBits: {id: number,
  ...
  {id: 3,
    ...
    // tslint:disable-next-line:max-line-length
    answer: `Sofia (/ˈsoʊfiə/ or /ˈsɒfiə/ or /soʊˈfiːə/;[12][13] Bulgarian: София, tr. Sofiya,[14][15] pronounced [ˈsɔfiə, ˈsɔfjə] (About this sound listen)) is the capital and largest city of Bulgaria. 1.26 million people live in the city and 1.68 million people live in its metropolitan area.[9] The c ity is at the foot of Vitosha Mountain in the western part of the country. Being in the centre of the Balkan peninsula, it is midway between the Black Sea and the Adriatic Sea, whereas the Aegean Sea is the closest to it.[16][17]       Sofia has been an area of human habitation since at least 7000 BC.[3] Being Bulgaria's primate city, Sofia is a hometown of many of the major local universities, cultural institutions and commercial companies.[18] Sofia is one of the top 10 best places for start-up business in the world, especially in information technologies.[19] Sofia is Europe's most affordable capital to visit as of 2013.[20]`
  },
  {id: 4,
    tag: 'Albania',
